...
EXTRA_OBJ = AImgimor.o
EXTRA_OBJ1 = AILTEric.o
EXTRA_OBJ2 = AIalfus.o
# Configuration
...
PLAYERS_OBJ = $(patsubst %.cc, %.o, $(PLAYERS_SRC)) $(EXTRA_OBJ) $(EXTRA_OBJ1) $(EXTRA_OBJ2) $(DUMMY_OBJ) $(BOARD_OBJ)
